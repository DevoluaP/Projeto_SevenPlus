    ...
    <body class="corpo">
            ...
            <nav class="cabecalho__navegacao">
                <ul class="cabecalho__navegacao__lista-esquerda">
                    <li class="cabecalho__navegacao__lista-esquerda__item">
                        <a href="#" class="cabecalho__navegacao__lista-esquerda__item__ancora">Início</a>
                    </li>
                    <li class="cabecalho__navegacao__lista-esquerda__item">
                        <a href="#" class="cabecalho__navegacao__lista-esquerda__item__ancora">Séries</a>
                    </li>
                    <li class="cabecalho__navegacao__lista-esquerda__item">
                        <a href="#" class="cabecalho__navegacao__lista-esquerda__item__ancora">Filmes</a>
                    </li>
                    <li class="cabecalho__navegacao__lista-esquerda__item">
                        <a href="#" class="cabecalho__navegacao__lista-esquerda__item__ancora">Minha lista</a>
                    </li>
                </ul>
        ...
        <footer class="rodape">
           ...
           <div class="rodape__listas">
                <ul class="rodape__listas__lista">
                    <li class="rodape__listas__lista__item">
                        <a href="#" class="rodape__listas__lista__item__ancora">
                            Idioma e legendas
                        </a>
                    </li>
                    <li class="rodape__listas__lista__item">
               ...
               <div class="rodape__listas__servico">
                    <button class="rodape__listas__servico__botao">Código do serviço</button>
                    <p>₢ 2024 Seven Plus, Inc</p>
               </div>
            </div>
        </footer>
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
        <script src="https://kit.fontawesome.com/edcab6d189.js" crossorigin="anonymous"></script>
    </body>
</html>